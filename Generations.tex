...
\newcommand*{\crm}[1]{%
%\MakeUppercase
\textsc{\romannumeral #1}}  % Chiffres romains % pas majuscules pour les siècles d'après l'Imprimerie Nationale
...
\newpagestyle{livre}{\sethead[\thepage][][\MakeUppercase\chaptertitle]{\MakeUppercase\sectiontitle}{}{\thepage}}
