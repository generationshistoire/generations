...
\newlength{\longueurcolonne} % une longueur ne doit être définie qu'une seule fois
\setlength{\longueurcolonne}{0.16666667\textwidth} % 6 colonnes, 1 ÷ 6 ≈ 0,16666667
...
%\newlength{\longueurcolonne} % une longueur ne doit être définie qu'une seule fois
\setlength{\longueurcolonne}{0.2\textwidth} % 5 colonnes, 1 ÷ 5 = 0,2
\addtolength{\longueurcolonne}{-2\tabcolsep}
...
\begin{tabular}{*{5}{>{\hspace{0pt}\centering\arraybackslash}b{\longueurcolonne}}}
