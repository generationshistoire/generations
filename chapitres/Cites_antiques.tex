...
que leurs pères conservaient le pouvoir de les diriger \latin{(manu)} et
...
mais est autorisé entre beaux-frères et belles-sœurs. La \latin{sobrina}
(cousine issue de germains) puis la \latin{consobrina} (cousine germaine) sont
...
\section{Le \latin{pater familias} romain}
