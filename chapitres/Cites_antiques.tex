...
\tempnote{Les notes sont en bas de page courante par défaut... On peut modifier ça aussi !}%
\footnote{Ainsi
...
\begin{enumerate}
%a) 
\item Il\tempnote{L'environnement enumerate est numéroté par défaut en chiffres arabes... modifier cela ? (numérotation alphabétique dans l'original)}
...
\tempnote{Au lieu d'une énumération, on pourrait peut-être utiliser un environnement qui mette simplement \textbf{en
valeur} le mot clé du paragraphe : ce serait sans doute plus fluide ?}
...
\footnote{Cité par Jean-Nicolas \fsc{Corvisier} et Wieslaw \fsc{Suder}, \emph{la population de l'antiquité classique},
Que sais-je, PUF, 2000.}
...
d'adoption incomplète. L'\emph{alumnus} n'entrait pas dans la famille de
...
\section{Le pater familias Romain}

\tempnote{- Est-ce que je prends trop de libertés en faisant une section ici ?

- Si on conserve, comment présenter ?}

Il ne faut pas confondre \siecles{3}{6} le patriarcat et la prééminence des hommes
