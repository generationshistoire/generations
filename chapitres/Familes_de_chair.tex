...
\section{Contrôle de la sexualité}
...
% [16]
\footnote{Cf. Georges \fsc{DUBY}, \emph{Le chevalier, la femme et le prêtre}, 1981.}% 
. Il a fallu que les tribunaux de l'Église obtiennent vers le \crm{10}\ieme{} ou \siecle{11} le monopole sur les affaires concernant le mariage pour que le vieux mot latin \latin{divortium} prenne le sens de séparation sans droit au remariage du vivant de l'autre conjoint, sens qu'il a gardé jusqu'à la Révolution. 
